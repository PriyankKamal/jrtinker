...
const Igcse = () => {
  ...
  return (
    ...
    <section className="w-full bg-emerald-500 py-20 pt-32 px-16 relative space-y-6">
      ...
      <h2 className="text-3xl nunito font-bold">IGCSE</h2>
      <h3 className="text-2xl nunito font-semibold">Tutoroot's One to One IGCSE Online Tuition for Grades 6 to 12</h3>
